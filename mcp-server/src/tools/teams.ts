  ...
  server.registerTool(
    ...
    async ({ team_id, channel_id, content, content_type }) => {
      try {
        ...
        return ok({ id: d["id"], createdDateTime: d["createdDateTime"], webUrl: d["webUrl"], sent: true });
      } catch (e) {
        return err(e);
      }
    }
  ...
  server.registerTool(
    ...
    async ({ team_id, display_name, description }) => {
      try {
        ...
        const d = res.data as Record<string, unknown>;
        return ok({ id: d["id"], displayName: d["displayName"], webUrl: d["webUrl"], created: true });
      } catch (e) {
        return err(e);
      }
    }
  ...
  server.registerTool(
    ...
    async ({ team_id, user_id, role }) => {
      try {
        ...
        const d = res.data as Record<string, unknown>;
        return ok({ id: d["id"], displayName: d["displayName"], roles: d["roles"], added: true });
      } catch (e) {
        return err(e);
      }
    }
