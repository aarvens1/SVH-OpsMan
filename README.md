...
**Layer 3 — AI Context**
Claude and Gemini configuration, skill definitions, and runtime reference files the AI reads during operations. Claude is the Ops Expert — full MCP access, owns incident response and all reporting. Claude Dev (`astevens2694@gmail.com`) owns the development lifecycle. Gemini does public web research only — four tiers (instant · quick · deep · research), cited sources, no MCP access.
